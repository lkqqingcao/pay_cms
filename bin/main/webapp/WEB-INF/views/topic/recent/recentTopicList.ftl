	...
	<div class="jarviswidget" id="wid-id-5">
		<div class="no-padding">
			<div class="widget-body no-padding-btm">
				<form class="smart-form" id="searchForm" action="${ctx}topic/recent/doList.htm" method="post" >
						...
						<div class="row">
							...
							<#--section class="col col-2">
								...
								<label class="input" >
									...
									<input type="text" name="imgPath" value="${(vo.apkId)!}" placeholder="输入小组包名"> <b class="tooltip tooltip-right"><i class="fa fa-warning txt-color-teal"></i>
										只允许精确匹配</b> 
								</label>
							</section-->
							<section class="col col-2">
										<label class="select"><select name="site">
					...
					<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
						...
						<div role="content" >
							...
							<div class="widget-body no-padding">
								 <div class="widget-body-toolbar" style="padding-bottom: 3px; padding-top: 3px; padding-left: 0px;display:none">
                                     <div class="col-md-6" style="padding-left: 4px;">
                                       <a class="btn btn-primary" href="javascript:void(0);" onclikc="common.tableReplace('${ctx}topic/recent/toEdit.htm')">添加新帖</a>
                                     </div>
                                 </div>
                                 <div id="tableDiv" >
                                  <#include "recentTopicTable.ftl">
                                 </div>
							</div>
							<!-- end widget content -->
						</div>
